...
export const App: React.FC = () => {
  ...
  const [timeStart, setSeconds] = useState<number>(
    parseInt(localStorage.getItem("counterValue") || "0") || 0
  );
      ...
      <div className={styles.layout}>
        ...
        <div className={`${styles.column} ${styles.columnRight}`}>
          ...
          <Button variant="contained" style={{ backgroundColor: "#DCE359" }}>
            <a style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}  href="https://t.me/laba2kvadratachat">
